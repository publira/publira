...
Everything under `src/__generated__/` is generated by `scripts/generate-locale-registry.ts` from `locales/index.json` and the catalog files. Never edit it by hand.
