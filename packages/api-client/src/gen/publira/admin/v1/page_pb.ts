...
/**
 * @generated from message publira.admin.v1.UnpublishPageRequest
 */
export type UnpublishPageRequest = Message<"publira.admin.v1.UnpublishPageRequest"> & {
  /**
   * @generated from field: publira.types.v1.TenantContext tenant = 1;
   */
  tenant?: TenantContext | undefined;
...
/**
 * Describes the message publira.admin.v1.UnpublishPageRequest.
 * Use `create(UnpublishPageRequestSchema)` to create a new message.
 */
export const UnpublishPageRequestSchema: GenMessage<UnpublishPageRequest> = /*@__PURE__*/
  messageDesc(file_publira_admin_v1_page, 14);

/**
 * @generated from message publira.admin.v1.UnpublishPageResponse
 */
export type UnpublishPageResponse = Message<"publira.admin.v1.UnpublishPageResponse"> & {
  /**
   * @generated from field: publira.types.v1.Page page = 1;
   */
  page?: Page | undefined;
...
/**
 * Describes the message publira.admin.v1.UnpublishPageResponse.
 * Use `create(UnpublishPageResponseSchema)` to create a new message.
 */
export const UnpublishPageResponseSchema: GenMessage<UnpublishPageResponse> = /*@__PURE__*/
...
export const RollbackToVersionRequestSchema: GenMessage<RollbackToVersionRequest> = /*@__PURE__*/
  messageDesc(file_publira_admin_v1_page, 16);
