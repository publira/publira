 ...
 *
 * @generated from message publira.admin.v1.TenantStoreProduct
 */
export type TenantStoreProduct = Message<"publira.admin.v1.TenantStoreProduct"> & {
  /**
...
/**
 * Describes the message publira.admin.v1.TenantStoreProduct.
 ...
 */
export type ListTenantStoreProductsRequest = Message<"publira.admin.v1.ListTenantStoreProductsRequest"> & {
  /**
   * @generated from field: publira.types.v1.TenantContext tenant = 1;
   */
  tenant?: TenantContext | undefined;
...
/**
 * Describes the message publira.admin.v1.ListTenantStoreProductsRequest.
 ...
 */
export type ListTenantStoreProductsResponse = Message<"publira.admin.v1.ListTenantStoreProductsResponse"> & {
  /**
   * Ordered by price. Only paid episodes the app may show and sell are counted.
   *
   * @generated from field: repeated publira.admin.v1.TenantStoreProduct products = 1;
   */
  products: TenantStoreProduct[];
};

/**
 * Describes the message publira.admin.v1.ListTenantStoreProductsResponse.
...
export const AdminPaymentSettingsService: GenService<{
  ...
  listTenantStoreProducts: {
    methodKind: "unary";
    input: typeof ListTenantStoreProductsRequestSchema;
    output: typeof ListTenantStoreProductsResponseSchema;
  },
}> = /*@__PURE__*/
