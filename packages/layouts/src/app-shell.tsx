...
export interface AppShellRenderHeaderProps {
  mobileNavOpen: boolean;
  onOpenMobileNav: () => void;
}

export interface AppShellRenderSidebarProps {
  mobileNavOpen: boolean;
  onClose: () => void;
  pathname: string;
}
...
export interface AppShellProps {
  children: ReactNode;
  gradient?: string;
  renderHeader: (props: AppShellRenderHeaderProps) => ReactNode;
  renderSidebar: (props: AppShellRenderSidebarProps) => ReactNode;
}
  ...
  return (
    <div className="relative min-h-dvh bg-background text-foreground">
      ...
      <div className="relative flex min-h-dvh">
        {renderSidebar({ mobileNavOpen, onClose: closeMobileNav, pathname })}

        <div className="flex min-w-0 flex-1 flex-col lg:pl-0">
          {renderHeader({ mobileNavOpen, onOpenMobileNav: openMobileNav })}
...
export interface AppShellCurrentUser {
  name: string;
  publicId: string;
  role: string;
}
