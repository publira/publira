 ...
 *
 * `items-center` is what settles the form against the panel beside it: the
 * panel is a window tall, so the column is too, and a form left at the top of
 * it would sit against a half-screen of nothing. A screen with no panel is as
 * tall as its own content, where centring a form in the height it just gave
 * itself is no move at all.
 */
