...
Wire **both**. With only one, the other path stays local in multi-instance deploys. Details: [the package README](https://www.npmjs.com/package/@publira/next-cache-handlers).
