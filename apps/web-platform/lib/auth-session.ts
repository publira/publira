 ...
 */
export const clearPlatformSessionCookie = async (): Promise<void> => {
 ...
 */
export const requirePlatformSession = async (): Promise<string> => {
 ...
 * exists to replace. `requirePlatformSession()` raises the redirect instead.
 *
