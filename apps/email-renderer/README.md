...
リポジトリルートを build context にして、Node.js 常駐サービス用の [`infra/docker/node/Dockerfile`](../../infra/docker/node/Dockerfile) をビルドします（[#958](https://github.com/publira/publira/issues/958)）。
