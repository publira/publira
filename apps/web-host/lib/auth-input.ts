...
export const authTokenFormSchema = (t: HostMessageAccessor) =>
  z
    .string()
    .trim()
...
export const tenantIdFormSchema = (t: HostMessageAccessor) => {
...
export const emailFormSchema = (t: HostMessageAccessor) => {
...
export const passwordFormSchema = (t: HostMessageAccessor) => {
