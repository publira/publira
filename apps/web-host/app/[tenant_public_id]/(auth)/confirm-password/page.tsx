...
const ConfirmPasswordFormContent = async ({
  ...
  searchParams: PageProps<"/[tenant_public_id]/confirm-password">["searchParams"];
  tenantPublicId: string;
}) => {
  await connection();
...
const ConfirmPasswordPageContent = async ({
  params,
  searchParams,
}: PageProps<"/[tenant_public_id]/confirm-password">) => {
  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <Suspense
        fallback={
          <ConfirmPasswordForm tenantPublicId={tenant_public_id} token="" />
        }
      >
...
const ConfirmPasswordPageFallback = () => (
  <div className="w-full max-w-sm">
    ...
    <ConfirmPasswordForm tenantPublicId="" token="" />
  </div>
);
