 ...
 *
 * Reach limit, measured: a server-side render failure answers a bare
 * `500 Internal Server Error` before this can render, so in practice this only
 * covers client navigations. See #683.
 */
const TenantError = ({
  error,
  retry,
