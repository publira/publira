...
interface ReaderStatusOption {
  label: string;
  value: string;
}

interface ReaderStatusSelectProps {
  defaultValue: string;
  options: readonly ReaderStatusOption[];
}

export const ReaderStatusSelect = ({
  defaultValue,
  options,
}: ReaderStatusSelectProps) => {
