 ...
 * every remaining implicit fallback in `web-admin` goes through this one
 ...
 * or the tenant's stored default to resolve instead, and a read that fails is
 * an outage to report rather than a language to choose.
 *
 * Resolving the locale on each of these paths, and deleting this, is #1248.
 */
