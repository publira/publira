...
func newContentViewFixture(t *testing.T) *contentViewFixture {
	...
	mock.ExpectQuery(regexp.QuoteMeta(getPublishedEpisodeByPublicIDQuery)).
		...
		WillReturnRows(sqlmock.NewRows([]string{
			...
			"series_public_id", "series_title", "series_eye_catch_image_id", "series_eye_catch_image_updated_at", "series_age_rating", "series_comment_mode", "reading_direction", "spread_start_index", "series_reading_direction", "series_spread_start_index", "free_until", "rating_count",
