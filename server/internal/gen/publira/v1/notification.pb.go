...
func (x *NotificationItem) Reset() {
	*x = NotificationItem{}
	mi := &file_publira_v1_notification_proto_msgTypes[0]
...
func (x *ListNotificationsRequest) Reset() {
	*x = ListNotificationsRequest{}
	mi := &file_publira_v1_notification_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListNotificationsRequest) Descriptor() ([]byte, []int) {
	return file_publira_v1_notification_proto_rawDescGZIP(), []int{1}
}
...
func (x *ListNotificationsResponse) Reset() {
	*x = ListNotificationsResponse{}
	mi := &file_publira_v1_notification_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListNotificationsResponse) Descriptor() ([]byte, []int) {
	return file_publira_v1_notification_proto_rawDescGZIP(), []int{2}
}
...
var File_publira_v1_notification_proto protoreflect.FileDescriptor

const file_publira_v1_notification_proto_rawDesc = "" +
	"\n" +
	"\x1dpublira/v1/notification.proto\x12\n" +
	"publira.v1\x1a\x1cpublira/types/v1/types.proto\"\xba\x01\n" +
	...
	"\x1aMarkAllNotificationsAsRead\x12-.publira.v1.MarkAllNotificationsAsReadRequest\x1a..publira.v1.MarkAllNotificationsAsReadResponse\"\x00BEZCgithub.com/publira/publira/server/internal/gen/publira/v1;publirav1b\x06proto3"

var (
	file_publira_v1_notification_proto_rawDescOnce sync.Once
	file_publira_v1_notification_proto_rawDescData []byte
)

func file_publira_v1_notification_proto_rawDescGZIP() []byte {
	file_publira_v1_notification_proto_rawDescOnce.Do(func() {
		file_publira_v1_notification_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_publira_v1_notification_proto_rawDesc), len(file_publira_v1_notification_proto_rawDesc)))
	})
...
func file_publira_v1_notification_proto_init() {
	if File_publira_v1_notification_proto != nil {
		return
	}
	type x struct{}
	...
	file_publira_v1_notification_proto_goTypes = nil
	file_publira_v1_notification_proto_depIdxs = nil
}
