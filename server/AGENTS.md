...
| `internal/gen/` | **buf-generated** protobuf / Connect stubs — do not hand-edit |
...
5. Never commit hand-edits to generated output. Regenerate instead. Every generator in this module writes into a directory named `gen/` under `internal/` — buf into `internal/gen/`, sqlc into `internal/db/gen/` — so no file outside one is generated and the rule needs no list of file names.
