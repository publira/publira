...
| Path | Role |
| --- | --- |
| `cmd/` | Thin entrypoints only (`api-server`, image servers, `outbox-worker`, and `batch` for the one-shot batch jobs) |
