...
audit_data(n, action, target_type, actor_role) AS (
    VALUES
        ...
        (6,  'episode_updated',                  'episode', 'tenant_admin'),
        ...
        (15, 'episode_updated',                  'episode', 'tenant_admin'),
        ...
        (23, 'episode_updated',                  'episode', 'tenant_admin'),
        ...
        (30, 'episode_updated',                  'episode', 'tenant_admin'),
        ...
        (38, 'episode_updated',                  'episode', 'tenant_admin'),
        ...
        (46, 'episode_updated',                  'episode', 'tenant_admin'),
